...
if __name__ == '__main__':
    import yaml
    config = yaml.load(open("/home/hess/caiyun-algo-misc/caiyun-era5-rainfall/models/ldm/models/test.yaml", "r"), Loader=yaml.Loader)
    model = AutoencoderKL(config['ddconfig'], config['lossconfig'], embed_dim=16)
